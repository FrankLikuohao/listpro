...
$query = "Select * From todolist  Where DATEDIFF(date(Date),CURDATE()) <=0  and DATEDIFF(date(Date),CURDATE()) >= -31 and  month(date(Date)) = Month(NOW()) and `Price` > 0 ORDER BY `Date` ASC";
