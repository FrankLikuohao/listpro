...
echo '
		<br >Iterm added</br>
		<form method="post" action="listprodevelop.php" enctype="multipart/form-data">
    ...
    echo '</tr>
		...
		<tr> 
		<td width="100">&nbsp;</td>
		<td>   Choose Files To Upload : <input type="file" id="thefile" onchange="checkSize()" name="File[]"  multiple  /> 
		<td id="showszie"></td>
		</tr>
		<tr> 
		<td width="100">&nbsp;</td>
...
imgs.width='16'
imgs.height='20'
imgs.onmouseover=function(){showtrail(310,440,tmpfilename);};
